...
class RealSpookyNet(SourceSpooky):
    ...
    def forward(self, batch):
        ...
        if full_nbrs:
            ...
            print('pase fullsssssssssssssssssssssssss')
        ...
        print(idx_i, idx_j ,xyz,Z,num_atoms, batch_seg,
              batch['charge'].to(self.float_dtype),
                batch['spin'].to(self.float_dtype),    )
        
        print('xyzzzzzzzzzzzzzz', xyz)
        print('Zzzzzzzzzzzzzzzzzz', Z)
        print('num_atoms', num_atoms)
        print('batch_seg', batch_seg)
        print('batch', batch['charge'].to(self.float_dtype))
        print('batchssssss',batch['spin'].to(self.float_dtype))
