...
class Trainer:
   ...
   """
    ...
    def __init__(
        ...
        self.activation = modelparam['activation']
        self.num_features = modelparam['num_features']
        self.num_basis_functions = modelparam['num_basis_functions']
        self.num_modules = modelparam['num_modules']
        self.num_residual_electron = modelparam['num_residual_electron']
        self.num_residual_pre = modelparam['num_residual_pre']
        self.num_residual_local_x = modelparam['num_residual_local_x']
        self.num_residual_local_s = modelparam['num_residual_local_s']
        self.num_residual_local_p = modelparam['num_residual_local_p']
        self.num_residual_local_d = modelparam['num_residual_local_d']
        self.num_residual_local = modelparam['num_residual_local']
        self.num_residual_nonlocal_q = modelparam['num_residual_nonlocal_q']
        self.num_residual_nonlocal_k = modelparam['num_residual_nonlocal_k']
        self.num_residual_nonlocal_v = modelparam['num_residual_nonlocal_v']
        self.num_residual_post = modelparam['num_residual_post']
        self.num_residual_output = modelparam['num_residual_output']
        self.basis_functions = modelparam['basis_functions']
        self.cutoff = modelparam['cutoff']
        self.lr_cutoff = modelparam['lr_cutoff']
        self.use_zbl_repulsion = modelparam['use_zbl_repulsion']
        self.use_electrostatics = modelparam['use_electrostatics']
        self.use_d4_dispersion = modelparam['use_d4_dispersion']
        self.compute_d4_atomic = modelparam['compute_d4_atomic']
        self.module_keep_prob = modelparam['module_keep_prob']
        self.Zmax = modelparam['Zmax']  
        self.exp_weighting = modelparam['exp_weighting'] 
    ...
    def state_dict(self):
        ...
        if self.torch_parallel:
            state_dict["state_dict"] = self._model.module.state_dict()
        else:
    ...
    def save(self, model):
        ...
        try:
            ...
            #print(self.state_dict,'self.state_dict',self.best_model)
        ...
        # be pickled
            ...
            state_path = self.best_model + ".pth.tar"
            torch.save(self.state_dict, state_path,state_path)
