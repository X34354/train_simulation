...
class SpookyNetEnsemble(nn.Module):
    ...
    Arguments:
        models (list of str):
            ...
            models (they are passed to the load_from argument of the PhysNet
            class).
    """
    ...
    def energy(
        ...
        (see documentation of energy in PhysNet class)
    ...
    def energy_and_forces(
        ...
        (see documentation of energy_and_forces in PhysNet class)
    ...
    def energy_and_forces_and_hessian(
        ...
        (see documentation of energy_and_forces_and_hessian in PhysNet class)
    ...
    def forward(
        ...
        (see documentation of forward in PhysNet class)
